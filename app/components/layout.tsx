  ...
  return (
    <div className="min-h-screen bg-background text-foreground p-4 sm:p-8 md:p-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-7xl mx-auto flex flex-col gap-12">
        <header className="flex flex-col sm:flex-row items-start justify-between gap-4 pb-6 animate-in fade-in slide-in-from-top-5 duration-700 ease-out">
          <div>
            ...
            <p className="text-muted-foreground mt-2 max-w-2xl">
              Explore all UI components available in this project. Browse,
              review usage, and see examples for each component below.
            </p>
          </div>
        ...
        <div className="bg-black/15 dark:bg-white/5 rounded-2xl shadow-2xl border border-white/10 animate-in fade-in slide-in-from-bottom-5 duration-700 ease-out flex flex-row overflow-hidden">
          <main className="p-4 sm:p-6 mx-auto w-full max-w-4xl">
            {children}
          </main>
        </div>
      </div>
